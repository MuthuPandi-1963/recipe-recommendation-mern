        ...
        {profile ? (
          <div className="grid w-screen">
            <div className="p-4 border rounded-2xl m-4 shadow font-bold justify-center w-auto">
              <h1 className="p-4 text-center w-fit bg-green-500 rounded-[50%] capitalize hover:bg-blue-700">
                {user?.data?.name?.[0]}
              </h1>
              <div className="">
            ...
            <div className="grow-1">
              ...
              <form
                action=""
                className="p-4 border rounded-2xl m-4 shadow font-bold justify-center w-auto"
              >
